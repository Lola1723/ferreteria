...
<body>
  <header>
    ...
    $id=$_GET['id'];
    $sql = $pdo->prepare("SELECT id, nombre, apellido, email from usuario WHERE id =:id");
    try {
      $sql->execute(['id'=> $id]);
        ...
        <div class="col-md-8 col-lg-8">
          ...
          if (isset($success)) { ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              ...
              <strong>Edición lograda con éxito!</strong>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="ged_usuario.php" method="post" id="formulariodeRegistro">
                <input type="hidden" name="id" id="id"  value="<?php echo $id; ?>">
                <div class="row mb-3">
                  <div class="col">
                    <div class="mb-3">
                      <label for="" class="form-label">Nombre</label>
                      <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $rs['nombre']; ?>"/>
                    </div>
                  </div>
                  <div class="col">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="apellido" id="apellido" aria-describedby="helpId"
                        placeholder="" value="<?php echo $rs['apellido']; ?>" />
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" name="email" id="email" aria-describedby="helpId"
                    placeholder="" value="<?php echo $rs['email']; ?>" />
                </div>
                  ...
                  <div class="col">
                    <div class="mb-3">
                      ...
                      <input type="password" class="form-control" name="password" id="password"
                        aria-describedby="helpId" placeholder="Escribe tu nueva contraseña" required autofocus/>
                    </div>
                  </div>
                  <div class="col">
                    <div class="mb-3">
                      ...
                      <input type="password" class="form-control" name="confirmarPassword" id="confirmarPassword"
                        aria-describedby="helpId" placeholder="Confirma la contraseña" required />
